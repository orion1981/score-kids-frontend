    ...
    <div>
      <h1>Box Score</h1>
       <Grid columns='equal'>
        ...
        <Grid.Row>
              <Grid.Column>
                <Segment color="blue" className="Home-stats"><h3>G: {this.props.players.homeGoalie.playerName} &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;|&nbsp; shots:{this.props.players.awayGoalie.shots} &nbsp;|&nbsp; assists:{this.props.players.awayGoalie.assists} &nbsp;|&nbsp; saves:{this.props.players.awayGoalie.saves} </h3></Segment>
              </Grid.Column>
              <Grid.Column>
